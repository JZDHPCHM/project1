...
public interface IrrSplitIndexService extends DaoService<IrrSplitIndexEntity, String, IrrSplitIndexRepository> {
	...
	/**
	 * 查询评估项目
	 * @param splitLevel 拆分层级
	 * @param channelFlagIsNull 渠道标识是否为空
	 * @return
	 * @throws Exception
	 */
	public List<IrrProjTypeEntity> findProjBySplitIndexCondition(String splitLevel,Boolean channelFlagIsNull) throws Exception;
