...
MAX(DECODE(IOR.INDEX_CODE,'OR02022',REPLACE(IOR.INDEX_RESULT_Q2,'<不适用>',''))) COL_21,
MAX(DECODE(IOR.INDEX_CODE,'OR02023',REPLACE(IOR.INDEX_RESULT_Q2,'<不适用>',''))) COL_22,
MAX(DECODE(IOR.INDEX_CODE,'OR02024',REPLACE(IOR.INDEX_RESULT_Q2,'<不适用>',''))) COL_23,
...
MAX(DECODE(IOR.INDEX_CODE,'OR02012',IOR.INDEX_RESULT_Q2)) COL_33,
MAX(DECODE(IOR.INDEX_CODE,'OR02011',IOR.INDEX_RESULT_Q2)) COL_34,
