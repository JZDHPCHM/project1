...
import org.wsp.framework.security.impl.jpa.filter.LDAPAuthenticationFilter;
import org.wsp.framework.security.impl.jpa.filter.LDAPUsernamePasswordAuthenticationFilter;
...
//			
//			//添加基于汉口银行LDAP统一的认证模式
//			LDAPUsernamePasswordAuthenticationFilter ldapUsernamePasswordAuthenticationFilter = new LDAPUsernamePasswordAuthenticationFilter();
//			ldapUsernamePasswordAuthenticationFilter.setAuthenticationManager(this.authenticationManager());
//			ldapUsernamePasswordAuthenticationFilter.setAuthenticationFailureHandler(new SimpleUrlAuthenticationFailureHandler(environment.getProperty("security.http.formLogin.failureUrl","/login-error.html")));
//			http.addFilterAt(ldapUsernamePasswordAuthenticationFilter, UsernamePasswordAuthenticationFilter.class);
//				
			...
			*/
			...
			http.formLogin()
					...
					.failureUrl(environment.getProperty("security.http.clent.uestTb","/loadUser/sync/user"))
					.permitAll()
					.and()
				//.httpBasic()
					//.and()
