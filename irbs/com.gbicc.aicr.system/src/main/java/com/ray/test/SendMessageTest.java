...
*/
	...
	public void testSendNewsMessage(){
		...
		//1.1非必需
		message.setTouser("WangShuaiHeng");  //不区分大小写
		message.setToparty("");
		...
		article1.setTitle("主体评级报告");
		article1.setDescription("");
		article1.setPicurl("http://res.mail.qq.com/node/ww/wwopenmng/images/independent/doc/test_pic_msg1.png");
		article1.setUrl("http://i9vn52.natappfree.cc/mainRating");
