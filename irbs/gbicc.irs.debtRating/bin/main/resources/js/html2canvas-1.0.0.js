...
(function (global, factory) {
  ...
  const BoundCurves = /** @class */ (function () {
    function BoundCurves(element) {
      ...
      let _a = getAbsoluteValueForTuple(styles.borderTopLeftRadius, bounds.width, bounds.height), tlh = _a[0], tlv = _a[1];
      let _b = getAbsoluteValueForTuple(styles.borderTopRightRadius, bounds.width, bounds.height), trh = _b[0], trv = _b[1];
      let _c = getAbsoluteValueForTuple(styles.borderBottomRightRadius, bounds.width, bounds.height), brh = _c[0], brv = _c[1];
      let _d = getAbsoluteValueForTuple(styles.borderBottomLeftRadius, bounds.width, bounds.height), blh = _d[0], blv = _d[1];
      const factors = [];
      ...
      const {borderTopWidth,} = styles;
      const {borderRightWidth,} = styles;
      const {borderBottomWidth,} = styles;
      const {borderLeftWidth,} = styles;
  ...
  const isClipEffect = function (effect) { return effect.type === 1; };
  ...
  const CanvasRenderer = /** @class */ (function () {
    ...
    CanvasRenderer.prototype.renderTextWithLetterSpacing = function (text, letterSpacing) {
      ...
      if (letterSpacing === 0) {
        ...
        const letters = toCodePoints(text.text).map(function (i) { return fromCodePoint(i); });
            ...
            if (styles.textDecorationLine.length) {
              ...
              styles.textDecorationLine.forEach(function (textDecorationLine) {
                ...
                case 1 /* UNDERLINE */:
                  ...
                  var {baseline,} = _this.fontMetrics.getMetrics(fontFamily, fontSize);
                ...
                case 3 /* LINE_THROUGH */:
                  ...
                  var {middle,} = _this.fontMetrics.getMetrics(fontFamily, fontSize);
