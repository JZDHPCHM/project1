...
var debtRateOption1 = {
    ...
    },
    {
        ...
        data: ['（超过全量客户的百分比）',]//类目数据，在类目轴（type: 'category'）中有效。
        //如果没有设置 type，但是设置了axis.data,则认为type 是 'category'。
    }],
    series: [
        {
...
$.ajax({
    ...
    success: function (data) {
    	...
    	$("#CREDIT_TYPE2").html(CREDIT_TYPE2?CREDIT_TYPE2:'无');    
...
$("#detail1").click(function(){
    ...
    success : function(data){
      if(data.FD_FINAL_SCO == '0'){
        ...
        post('/irs/assetsRating/assetsRatingReport',{custNo :data.CUSTNO});
      }
    }
  })
	...
	$.ajax({
      ...
      success : function(data){
        if(data.FD_SCO == '0'){
          ...
          post('/irs/mainRating/mainRatingReport',{custNo :data.CUSTNO});
        }
      }
    })
