...
@Entity
@Table(name="NS_CREDIT_INDEXES")
public class CreditIndex extends AuditorEntity implements Serializable {
	...
	//指标类型
	@Column(name = "FD_INDEXTYPE")
	@Enumerated(EnumType.STRING)
	private RatingStepType indexType;

	//指标分类
	@Column(name = "FD_INDEXCATEGORY")
	private String indexCategory;
	
	//指标名称
	@Column(name = "FD_INDEXNAME")
	private String indexName;
		
	//指标配置ID
	@Column(name = "FD_CONFIGID")
	private String indexConfigId;
	
	//指标ID
	@Column(name = "FD_INDEXID")
	private String indexId;
	
	//指标编号
	@Column(name = "FD_INDEXCODE")
	private String indexCode;
	
	//指标值
	@Column(name = "FD_INDEXVALUE")
	...
	@Column(name = "FD_RATING_STATUS",length = 2000)
	private String ratingStatus;
	
	@Column(name = "CREDIT_TYPE",length = 2000)
	private String creditType;
	
	@Column(name = "CREDIT_NUMBER",length = 2000)
...
//	public RatingAssetsStep getRatingStep() {
//		return ratingStep;
//	}
//
//	public void setRatingStep(RatingAssetsStep ratingStep) {
