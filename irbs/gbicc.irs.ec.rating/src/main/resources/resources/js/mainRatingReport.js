...
var id=getCustNo();
//0daf1a7f-b01a-4f9f-88ed-1b5b12a33d6a
$.ajax({
    async: false,
    type: "GET",
    ...
    success: function (data) {
       ...
       $("#company span").html('（客户编号：'+(data.FD_CUST_CODE?data.FD_CUST_CODE:"")+'）');
    }
});
...
$.ajax({
    ...
    success: function (data) {
       ...
       if(DESCRIBE){
    	   ...
    	   $("#list_sp2").parent('li').hide;  
       }
       if(WARNING){
    	   $("#list_sp3").html(WARNING);  
       }else{
    	   $("#list_sp3").parent('li').hide;  
       }
    ...
    series: [
        {
            ...
            data: [{ value: number*540, name: LEVELED?LEVELED:'' }],
            axisTick: {
                show: true,
                splitNumber: 15,
                lineStyle: {
...
$.ajax({
    ...
    success: function (data) {
       ...
       $('#content1_right1_3_bottom_3').attr("title",FD_SEGMENT_INDUSTRY);
       $('#content1_right1_3_bottom_2').html(TRACK_TYPE+'   <span>(赛道类型)</span>');
       $('#content1_right1_3_bottom_1').html(FD_TYPE+'   <span>(企业类型)</span>');
...
$.ajax({
	//async: false,
	type: "GET",
	url: "/irs/ratingIndex/getMainTrait?id=" + id,
	contentType: false,
	cache: false,
	processData: false,
	success: function (data) {
