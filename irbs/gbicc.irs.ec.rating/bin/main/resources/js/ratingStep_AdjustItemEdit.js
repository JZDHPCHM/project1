...
isc.FwListGrid.create({
		...
		dataSource : ratingIndexByAdjItemDS,
		fields: RatingAdjItemFields.grid,
		initialCriteria : {
...
//加载数据，展开行，存储定性选项
adjustItemGrid.fetchData(adjustItemGrid.getCriteria(),function(optional){
	...
	adjustItemGrid.expandRecords(optional.data);
});
...
isc.HLayout.create({
        ...
        membersMargin: 10,
        align: "center",
        members:[preBtn_AdjItem,nextBtn_AdjItem]
});
