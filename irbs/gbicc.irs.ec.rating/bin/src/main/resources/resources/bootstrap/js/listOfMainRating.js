...
$(document).ready(function(){
	$("#table_list").jqGrid({
        ...
        rowNum: 20,
        rowList: [10, 20, 30],
        colNames:['承租人编号','承租人名称','承租人类型','国标行业','高精尖产业分类','高新技术企业类型', '经济类型', '评级编号', '评级类型','初评等级','复核等级','违约概率','评级类型','评级日期','操作'],
        colModel:[
            ...
            {name:'segmentindustry',index:'segmentindustry', editable: true,formatter:function(value,row,index){
