 ...
 */
@Entity
@Table(name="IRS_REPORT_PROFIT_BRANCH")
public class ReportProfitBranch extends AuditorEntity implements Serializable{
	 ...
	 * @since JDK 1.8  
	 */
	private static final long serialVersionUID = -5754790816698582775L;
	...
	private Integer fdRepTime;

	@Column(name="FD_YEAR")
	private Integer year;

	public ReportProfitBranch() {
	}
	...
	public Integer getFdRepTime() {
		return fdRepTime;
	}

	public void setFdRepTime(Integer fdRepTime) {
