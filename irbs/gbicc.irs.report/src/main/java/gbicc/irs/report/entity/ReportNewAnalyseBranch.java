...
/**
 * 
 * ClassName: ReportNewAnalyseBranch <br/>  
 * Function: TODO ADD FUNCTION. <br/>  
 * Reason: 新增违约客户集中度分布—分支机构. <br/>  
 * date: 2019年4月24日 下午3:12:09 <br/>  
 *  
 * @author xiaoxianlie
 * @version   
 * @since JDK 1.8
 */
@Entity
@Table(name="IRS_REPORT_NEW_ANAL_BRANCH")
public class ReportNewAnalyseBranch extends AuditorEntity implements Serializable{
