...
/**
 * ClassName: ReportMoveGrant <br/>
 * Function: TODO ADD FUNCTION. <br/>
 * Reason: TODO ADD REASON(可选). <br/>
 * date: 2019年5月5日 下午5:06:49 <br/>
 *
 * @author xiaoxianlie
 * @since JDK 1.8
 */
@Entity
@Table(name = "IRS_REPORT_MOVE_GRANT")
public class ReportMoveGrant extends AuditorEntity implements Serializable {
